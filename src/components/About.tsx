  ...
  render() {
    return (
      <section>
        ...
        <p>In my personal life I loves expressing myself through music. This includes playing in bands like Seance Crasher and producing my own songs and compositions.</p>
